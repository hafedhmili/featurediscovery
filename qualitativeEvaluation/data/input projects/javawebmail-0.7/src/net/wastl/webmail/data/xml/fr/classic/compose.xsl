	...
	<FORM ACTION="{$base}/send?session-id={$session-id}" METHOD="POST">
	  <TABLE BGCOLOR="#dddddd" CELLSPACING="0" CELLPADDING="5" BORDER="0">
	    <TR>
	      ...
	      <TD VALIGN="CENTER">
		<FONT SIZE="+2"><STRONG>Composer un message...</STRONG></FONT> (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=compose">Aide</A>)<BR/>
	    ...
	    <TR>
	      <TD><STRONG>Docs Attachés:</STRONG></TD>
	      <TD COLSPAN="3">
	    ...
	    <TR>
	      <TD COLSPAN="2" ALIGN="LEFT"><INPUT TYPE="SUBMIT" VALUE="Envoyer message..." NAME="SEND"/></TD>
	      <TD COLSPAN="2" ALIGN="RIGHT"><INPUT TYPE="SUBMIT" VALUE="Attacher fichiers..." NAME="ATTACH"/></TD>
	    </TR>
	    <TR>
