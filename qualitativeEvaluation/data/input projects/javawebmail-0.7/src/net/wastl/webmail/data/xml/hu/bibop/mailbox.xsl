...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:output method="html" indent="yes"/>
	...
	<P class="testoChiaro">
	  <SPAN class="testoScuro">Köszöntjük a levelezőben, <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/>.</SPAN><BR/>
	  ...
	  Az Ön Postafiókja a következő mappákat tartalmazza 
