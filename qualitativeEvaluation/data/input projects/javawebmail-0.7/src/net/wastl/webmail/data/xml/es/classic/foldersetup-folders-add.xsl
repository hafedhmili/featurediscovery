        ...
        <TABLE BGCOLOR="#dddddd" CELLSPACING="0" BORDER="0" WIDTH="100%">
          <TR>
            ...
            <TD VALIGN="CENTER" COLSPAN="2">
              <FONT SIZE="+2">
                <STRONG>JWebMail Configuraci&#243;n de Carpetas para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/></STRONG>
              </FONT>
              <BR/>
              <EM>Nombre de usuario <xsl:value-of select="normalize-space(/USERMODEL/USERDATA/LOGIN)"/></EM>
              <BR/>
        ...
        <FORM ACTION="{$base}/folder/setup?session-id={$session-id}&amp;method=folder&amp;addto={/USERMODEL/STATEDATA/VAR[@name='add to folder']/@value}" METHOD="POST">
          <TABLE WIDTH="100%">
            <TR>
              ...
              <TD>
                <STRONG>Tipo de Carpeta</STRONG>
              </TD>
              <TD>
                <SELECT NAME="folder_type">
                  <OPTION value="msgs">tiene mensajes</OPTION>
                  <OPTION value="folder">tiene carpetas</OPTION>
                  <OPTION value="msgfolder">tiene carpetas y mensajes</OPTION>
                </SELECT>
              </TD>
            </TR>
            <TR>
