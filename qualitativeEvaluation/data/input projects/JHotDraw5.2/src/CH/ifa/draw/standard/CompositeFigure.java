...
public abstract class CompositeFigure
    ...
    public void addAll(Vector newFigures) {
        Iterator k = newFigures.iterator();
        while (k.hasNext())
            add((Figure) k.next());
    }
    ...
    public void removeAll(Vector figures) {
        Iterator k = figures.iterator();
        while (k.hasNext())
            remove((Figure) k.next());
    }
    ...
    public void write(StorableOutput dw) {
        ...
        Iterator k = fFigures.iterator();
        while (k.hasNext())
            dw.writeStorable((Storable) k.next());
    }
