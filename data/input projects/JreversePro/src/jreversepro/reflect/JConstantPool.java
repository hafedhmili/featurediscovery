...
public class JConstantPool  implements KeyWords {
    ...
    /**
	 * The constantpool is the one and only source that contains the references to external types. Hence all the entries are analyzed for all external types referred to by this class and are consolidated into a class called JImport. This JImport can further be used to get the short form of classname etc.
	 * @return  Reference to JImport.
	 * @uml.property  name="importedClasses"
	 */
