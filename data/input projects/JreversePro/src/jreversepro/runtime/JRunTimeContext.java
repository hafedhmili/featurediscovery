...
public class JRunTimeContext
     ...
     * @exception RevEngineException thrown while generating the
    ...
    public void pushControlEntry(JBranchEntry newent)
        ...
        if (!jcs.empty()) {
            if (newent.getEndBlockPc() == -1) {
                ...
                if (newent.getType() == TYPE_CATCH 
                                || newent.getType() == TYPE_CATCH_ANY) {
                ...
                } else if (newent.getType() == TYPE_TRY 
                            && (currBlock.getType() == TYPE_CATCH 
     ...
     * @exception RevEngineException Thrown in case of any problem
     * writing variable names in the table.
     */
    public void writeVariableDeclarations(JBranchEntry ent,
                                        JSymbolTable symTable)
                                 throws RevEngineException {
        Enumeration enumVariables = Collections.enumeration(
     ...
     * must be TYPE_TRY.
     * @exception   RevEngineException Thrown if these validations are not
     * satisfied.
     **/
