...
public class JLocalEntry {
    ...
    /**
	 * @return  Returns Variable Index into the bytecode array  for this method.
	 * @uml.property  name="varIndex"
	 */
	 ...
	 * @uml.property  name="lastReferredIndex"
	 */
