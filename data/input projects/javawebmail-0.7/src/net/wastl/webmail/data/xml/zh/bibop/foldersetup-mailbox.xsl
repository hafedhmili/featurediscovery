  ...
  <xsl:output method="html" indent="yes"/>
	...
	<TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
	 <FORM ACTION="{$base}/folder/setup?session-id={$session-id}&amp;method=mailbox&amp;add=1" METHOD="POST">
	  <TR> 
	    <TD colspan="4" height="22" class="testoNero">
	      <IMG SRC="{$imgbase}/images/icona_folder.gif" align="absmiddle"/>
	       <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/> 的 WebMail 收信匣設定 （<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=folder-setup-mailboxes">求救</A>）
	    </TD>
	   </TR>
	   <TR>
	  ...
	  <TR>
	    <TD bgcolor="#A6B1C0" colspan="4" height="22" align="center" class="testoGrande">刪除信箱</TD>
	  </TR>
	  <xsl:for-each select="/USERMODEL/USERDATA/MAILHOST">	    
		...
		<xsl:apply-templates select="MH_URI"/>
	      ...
	      <TD width="25%" class="testoNero" bgcolor="#E2E6F0"><A HREF="{$base}/folder/setup?session-id={$session-id}&amp;method=mailbox&amp;remove={@id}">刪除</A></TD>		
	    </TR>
	  </xsl:for-each>
	  <TR>
	    <TD bgcolor="#A6B1C0" colspan="4" height="22" align="center" class="testoGrande">新增信箱</TD>
	  </TR>
	  <TR>
	    <TD width="25%" bgcolor="#E2E6F0" class="testoNero">信箱名稱：</TD>
	    <TD width="75%" colspan="3" class="testoNero" bgcolor="#D1D7E7">
	      <INPUT TYPE="text" SIZE="25" NAME="mbox_name" class="testoNero"/>
	    </TD>
	  </TR>
	  <TR>
	    <TD width="25%" class="testoNero" bgcolor="#E2E6F0">電子郵件伺服器名稱：</TD>
	    <TD width="25%" class="testoNero" bgcolor="#D1D7E7"><INPUT TYPE="text" SIZE="10" NAME="mbox_host" class="testoNero"/>
	    </TD>
	    <TD width="25%" class="testoNero" bgcolor="#E2E6F0">通訊協定：</TD>
	  ...
	  <TR>
	    <TD width="25%" class="testoNero" bgcolor="#E2E6F0">登入帳號：
	    </TD>
	    <TD width="25%" class="testoNero" bgcolor="#D1D7E7">
	      <INPUT TYPE="text" SIZE="10" NAME="mbox_login" class="testoNero"/>
	    </TD>
	    <TD width="25%" class="testoNero" bgcolor="#E2E6F0">密碼：
	    </TD>
	    <TD width="25%" class="testoNero" bgcolor="#D1D7E7">
	  ...
	  <TR>
	    <TD colspan="4" align="center" class="testoNero" bgcolor="#A6B1C0">
	      <INPUT TYPE="submit" NAME="submit" VALUE="新增信箱" class="testoNero"/>
	    </TD>
	  </TR>
	</FORM>
      </TABLE>
