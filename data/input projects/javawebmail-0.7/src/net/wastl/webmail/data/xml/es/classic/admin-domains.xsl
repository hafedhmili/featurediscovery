...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <HTML>
      <HEAD>
        <TITLE>WebMail Interfaz de administraci&#243;n: Configuraci&#243;n de Dominios Virtuales</TITLE>
        <META CONTENT="AUTHOR" VALUE="Sebastian Schaffert"/>
      </HEAD>
      <BODY BGCOLOR="#ffffff">
        <CENTER>
          <H1>WebMail Virtual Domain Configuration</H1>
        </CENTER>
        <FORM ACTION="{$base}/admin/domain/set?session-id={$session-id}" METHOD="POST">
          <TABLE WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
            <TR BGCOLOR="lightblue">
              ...
              <TD>
                <STRONG>Host Restriction</STRONG>
              </TD>
