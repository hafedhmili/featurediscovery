...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    ...
    <HTML>
      <HEAD>
        <TITLE>WebMail Bejelentkezési képernyő</TITLE>
	...
	<P align="center">&#160;</P>
		  ...
		  <TR>
			...
			<TR>
			  ...
			  <TD bgcolor="#7B889F" height="50" width="190" class="testo">
			    <INPUT TYPE="submit" value="Belép" class="testo"/>
			    <INPUT TYPE="reset" value="Töröl" class="testo"/>
			  </TD>
			...
			<TR>
              ...
              WebMail </SPAN> mely a következőn alapul<BR/>
	  ...
	  <xsl:if test="/GENERICMODEL/STATEDATA/VAR[@name='invalid password']/@value = 'yes'">
	    <!-- START invalid pass -->
	    <P align="center" class="testo"><SPAN class="bold">Hibás bejelentkezés</SPAN>. A jelszó mező üres volt vagy a név/jelszó páros nem volt megfelelő! A kísérlet naplózva!</P>
	    <P align="center">&#160;</P>
	    <P align="center">&#160;</P>
	    <!-- END invalid pass -->
	  </xsl:if>
