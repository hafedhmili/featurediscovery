...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:output method="html" encoding="UTF-8"/>
	...
	<TABLE BGCOLOR="#dddddd" CELLSPACING="0" BORDER="0" WIDTH="100%">
	  ...
	  <TR>
	    <TD COLSPAN="3" BGCOLOR="#aaaaaa" ALIGN="CENTER"><STRONG>Supprimer Boîtes aux Lettres</STRONG></TD>
	  </TR>
	  ...
	  <TR>
		...
		<TABLE WIDTH="100%">
		  <TR>
		    <TD><STRONG>Nom Boîte aux lettres:</STRONG></TD>
		    <TD COLSPAN="3"><INPUT TYPE="text" SIZE="30" NAME="mbox_name"/></TD>
		  </TR>
		  <TR>
		    <TD><STRONG>Hôte serveur de Messagerie:</STRONG></TD>
