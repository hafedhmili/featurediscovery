...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:output method="html" indent="yes" encoding="UTF-8"/>
    ...
    <HTML>
      <HEAD>
        <TITLE>WebMail Fehlerbenachrichtigung</TITLE>
	...
	<TABLE WIDTH="100%">
	  <TR bgcolor="#A6B1C0">
	    <TD COLSPAN="2" align="center" class="testoGrande">Ein Fehler trat auf</TD>
	  </TR>
	  <TR>
	    <TD class="testoNero"><SPAN class="testoGrande">Fehlernachricht</SPAN></TD>
	    <TD class="testoNero">
	  ...
	  <TR>
		...
		<TR>
		  <TD><SPAN class="testoGrande">Spur auf Keller:</SPAN><BR/>
		    <PRE>
