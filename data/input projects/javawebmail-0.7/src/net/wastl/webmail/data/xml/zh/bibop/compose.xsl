	...
	<FORM ACTION="{$base}/send?session-id={$session-id}" METHOD="POST">
	  <TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
	    <TR>
	      ...
	      撰寫新信件... (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=compose">求救</A>)
		</TD>
	    </TR>
	    <TR>
	    ...
	    <TR>
	      <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">收件人:</TD>
	    ...
	    <TR>
	      ...
	      <TD height="22" class="testoNero" width="87%" bgcolor="#E2E6F0">
		  <INPUT TYPE="TEXT" NAME="REPLY-TO" SIZE="80" class="testoNero" VALUE="{$work/HEADER/REPLY-TO}"/>
		</TD>
	    </TR>
	    <TR>
	      <TD height="22" class="testoGrande" width="13%" bgcolor="#D1D7E7">
	    ...
	    <TR>
		  ...
		  <INPUT TYPE="SUBMIT" class="testoNero" VALUE="附加檔案..." NAME="ATTACH"/>
		</TD>
	      <TD class="testoNero" align="right" width="87%" bgcolor="#E2E6F0">
		  <INPUT TYPE="SUBMIT" class="testoNero" VALUE="送出信件..." NAME="SEND"/>
		</TD>
	    </TR>
	    <TR>
