...
public  class StandardDrawingView
     ...
     */
    private Iterator selectionHandles() {
        if (fSelectionHandles == null) {
            fSelectionHandles = new Vector();
            FigureEnumeration k = selectionElements();
            while (k.hasNext()) {
                Figure figure = k.nextFigure();
                Iterator kk = figure.handles().iterator();
                while (kk.hasNext())
                    fSelectionHandles.addElement(kk.next());
            }
        }
        return fSelectionHandles.iterator();
    }
    ...
    public Handle findHandle(int x, int y) {
        ...
        Iterator k = selectionHandles();
        while (k.hasNext()) {
            handle = (Handle) k.next();
