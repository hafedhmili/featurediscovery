...
public class PertFigure extends CompositeFigure {
    ...
    public int start() {
        int start = 0;
        Iterator i = fPreTasks.iterator();
        while (i.hasNext()) {
            PertFigure f = (PertFigure) i.next();
    ...
    public void notifyPostTasks() {
        Iterator i = fPostTasks.iterator();
        while (i.hasNext())
            ((PertFigure) i.next()).updateDurations();
    }
    ...
    public boolean hasCycle(Figure start) {
        ...
        Iterator i = fPreTasks.iterator();
        while (i.hasNext()) {
            if (((PertFigure) i.next()).hasCycle(start))
                return true;
        }
        return false;
    }
    ...
    public void writeTasks(StorableOutput dw, Vector v) {
        ...
        while (i.hasNext())
            dw.writeStorable((Storable) i.next());
    }
